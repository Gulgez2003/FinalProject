namespace FinalProject.app.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterDto registerDto)
        {
            ...
            mail.From = new MailAddress("siriushotel311@gmail.com", "SiriusHotel");
            mail.To.Add(new MailAddress(user.Email));
            mail.Subject = "Please verify your email for Sirius Hotel";
            mail.IsBodyHtml = true;
            string body = string.Empty;

            using(StreamReader stream=new StreamReader("wwwroot/assets/HtmlTemplate/htmlpage.html"))
            {
